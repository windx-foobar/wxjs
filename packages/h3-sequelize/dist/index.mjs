import { eventHandler, isEvent } from 'h3';
import { defineSequelizeConnection, useModel as useModel$1, scanModelsFolder, defineModels as defineModels$1 } from '@wxjs/sequelize';
...
function useModel(event, modelName) {
  ...
  return useModel$1(sequelize, modelName);
}
async function defineModels(sequelize, modelsDir) {
  ...
  return defineModels$1(sequelize, modelsDefs);
}

export { defineModels, defineSequelize, useModel, useSequelize };
